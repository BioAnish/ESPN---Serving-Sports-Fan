...
const SoccerTeamPage = () => {
  const [selectedTeams, setSelectedTeams] = useState("English Premier League");
        ...
        <div className={style.col_one}>
          <Card padding={"16px"}>
            <div className={style.TeamsWrapper}>
              ...
              {selectedTeams === "English Premier League" && (
                  ...
                  <div className={style.Teams__layout__column}>
                    <div className={style.ContentList}>
                      <div className={style.ContentList__Item}>
                        <section className={style.TeamLinks}>
                          <a>
                            <img src="https://a.espncdn.com/combiner/i?img=/i/teamlogos/soccer/500/86.png&scale=crop&cquality=40&location=origin&w=80&h=80" />
                          </a>
                          <div className={style.Teamname}>
                            <a className={style.AnchorLink} tabIndex={0}>
                              <h2>Real Madrid</h2>
                      ...
                      <div className={style.ContentList__Item}>
                        <section className={style.TeamLinks}>
                          <a>
                            <img src="https://a.espncdn.com/combiner/i?img=/i/teamlogos/soccer/500/83.png&scale=crop&cquality=40&location=origin&w=80&h=80" />
                          </a>
                          <div className={style.Teamname}>
                            <a className={style.AnchorLink} tabIndex={0}>
                              <h2>Barcelona</h2>
                      ...
                      <div className={style.ContentList__Item}>
                        <section className={style.TeamLinks}>
                          <a>
                            <img src="https://a.espncdn.com/combiner/i?img=/i/teamlogos/soccer/500/1068.png&scale=crop&cquality=40&location=origin&w=80&h=80" />
                          </a>
                          <div className={style.Teamname}>
                            <a className={style.AnchorLink} tabIndex={0}>
                  ...
                  <div className={style.Teams__layout__column}>
                    <div className={style.ContentList}>
                      <div className={style.ContentList__Item}>
                        <section className={style.TeamLinks}>
                          <a>
                            <img src="https://a.espncdn.com/combiner/i?img=/i/teamlogos/soccer/500/89.png&scale=crop&cquality=40&location=origin&w=80&h=80" />
                          </a>
                          <div className={style.Teamname}>
                            <a className={style.AnchorLink} tabIndex={0}>
                              <h2>Real Sociedad</h2>
